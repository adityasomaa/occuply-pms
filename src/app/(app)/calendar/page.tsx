  ...
  return (
    <div className="flex flex-1 flex-col gap-5 p-5 lg:p-7">
      ...
      <StatStrip
        stats={[
          {
            label: "Occupancy · next 14 nights", icon: CalendarCheckIcon, tone: "orange",
            value: percent(occNext14),
            hint: `${soldNext14} of ${units * 14} room nights sold`,
          },
          {
            label: "Revenue on the books", icon: WalletIcon, tone: "green",
            value: moneyShort(revenueOnBooks),
            hint: "Confirmed room revenue for the window",
          },
          {
            label: "Arrivals in window", icon: LogInIcon, tone: "blue",
            value: String(upcoming.length),
            hint: `${pending.length} still awaiting confirmation`,
          },
          {
            label: "Rate events", icon: SparklesIcon, tone: "violet",
